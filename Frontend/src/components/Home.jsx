...
export default function Home() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const response = await axios.get('http://localhost:5001/api/stats/public');
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { 
                count: loadingStats ? "..." : `${stats.startupsRegistered}+`, 
                label: "Startups Registered", 
                color: "from-green-500 to-green-400",
                icon: <Target className="w-8 h-8 text-white" />
              },
              { 
                count: loadingStats ? "..." : `${stats.approvalsGranted}+`, 
              ...
              { 
                count: loadingStats ? "..." : `${stats.activeUsers}+`, 
                label: "Active Users", 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl hover:border-green-400 transition-colors duration-300 group">
                  <span className="font-medium text-gray-700">Government Scheme Guide PDF</span>
                  <a 
                    href="/government-scheme-guide.html" 
                    target="_blank"
