...
function Register() {
  ...
  const handleRegister = async () => {
    const { fullName, email, mobile, ayushSystem, password, confirmPassword, agreed } = formData;
    ...
    try {
      ...
      setErrorMsg(error.response?.data?.error || error.response?.data?.details || 'Failed to register');
    }
  };
